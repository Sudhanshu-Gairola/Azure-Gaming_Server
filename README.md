...
#### Automated Standard
<a href="https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FSudhanshu-Gairola%2FAzure-Gaming_Server%2Fmaster%2FStandard.json" target="_blank">
...
You can monitor the progress of the deployment using the notification button (bell icon) on the top right. You can also check the status under Virtual Machine -> Sudhanshu_Gairola -> Extensions -> the only entry in the list. If you see an error or failure, submit an issue on GitHub along with what's in detailed status.
...
* Standard VM
    ...
    1. Go to Virtual machines in [Azure Portal](https://portal.azure.com/) and click on Virtual Machine.
...
3. Download https://github.com/Sudhanshu-Gairola/Azure-Gaming_Server/blob/master/setup.ps1. You could download this onto your local machine and paste it through remote desktop.
...
3. Click on the VM you've created (for automated, the VM name is Sudhanshu_Gairola). 
