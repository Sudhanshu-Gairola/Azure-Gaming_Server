...
function Install-VPN {
    ...
    $url = "https://github.com/Sudhanshu-Gairola/Azure-Gaming_Server/raw/master/$cert"
...
function Set-ScheduleWorkflow ($admin_username, $admin_password, $manual_install) {
    ...
    $url = "https://raw.githubusercontent.com/Sudhanshu-Gairola/Azure-Gaming_Server/master/$script_name"
